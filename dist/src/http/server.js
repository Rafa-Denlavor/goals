...
app.register(routes_1.mainRoute);
app.register(create_goal_1.createGoalRoute);
app.register(create_completion_goal_1.createCompletionGoalRoute);
app.register(get_pending_goals_1.getPendingGoalRoute);
app.register(get_week_summary_1.getSummaryRoute);
app
    .listen({
    port: 3333,
})
